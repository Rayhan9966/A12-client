	...
	<div className="p-3">
		...
		<div className="flex flex-wrap items-center pt-3 pb-1">
			<div className="flex items-center space-x-2">
				...
				<span className="text-sm">Adress:{PermanentDivisionName}<br></br>
					<span className="font-semibold">Age:{Age}</span><br></br>
					<span className="font-semibold">Occupation:{Occupation}</span><br></br>
				</span>
			</div>
